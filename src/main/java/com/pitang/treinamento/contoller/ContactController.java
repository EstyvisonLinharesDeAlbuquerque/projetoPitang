...
public class ContactController {
	...
	@ResponseBody
	public ResponseEntity<?> deleteContact(@PathVariable("id") Long id, @PathVariable("id2") Long id2) {
		if (contactService.listContacts(id) == null) {
			return new ResponseEntity<>(HttpStatus.NOT_FOUND);
		}
		contactService.deleteContact(id, id2);
